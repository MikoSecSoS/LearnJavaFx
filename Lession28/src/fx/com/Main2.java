...
public class Main2 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        anchorPane.setTopAnchor(splitMenuButton, 200.0);
        ...
        splitMenuButton.setMaxHeight(200);

        splitMenuButton.getItems().addAll(menuItem3, menuItem4, menuItem5);
